...
export const APP_THEMES = {
  ...
  // ... after charcoal, before the closing } satisfies ...

  crimsonDark: {
    pageBackground:          "bg-gradient-to-br from-neutral-950 via-red-950 to-neutral-950",
    headerBackground:        "bg-black/40",
    headerBorder:            "border-red-900/40",
    footerBubbleBackground:  "bg-red-900/30",
    cardBackground:          "bg-neutral-900/80 backdrop-blur-xl border border-red-900/30",
    cardActiveBackground:    "active:bg-red-900/30",
    cardHighlightBackground: "bg-gradient-to-br from-red-900/50 to-neutral-900/80 backdrop-blur-xl border border-red-700/40",
    primaryText:             "text-white",
    secondaryText:           "text-red-200/60",
    buttonBackground:        "bg-red-900/40",
    buttonActiveBackground:  "bg-red-600/70",
    buttonText:              "text-red-100",
    buttonActiveText:        "text-white",
    iconColor:               "text-red-200",
    iconBackground:          "bg-red-900/40",
    sliderTrackColor:        "red",
    sliderColorSettings:     "gradient",
    sliderThumbType:         "circle",
    sliderSize:              "md",
    accentColor:             "red",
    okBackground:            "bg-neutral-800",
    okBackgroundActive:      "bg-red-700",
  },

  studioLight: {
    pageBackground:          "bg-gradient-to-br from-white via-gray-50 to-red-50",
    headerBackground:        "bg-white/90",
    headerBorder:            "border-gray-200",
    footerBubbleBackground:  "bg-gray-100",
    cardBackground:          "bg-white border border-gray-200 shadow-sm",
    cardActiveBackground:    "active:bg-red-50",
    cardHighlightBackground: "bg-gradient-to-br from-red-50 to-white border border-red-200 shadow-md",
    primaryText:             "text-gray-900",
    secondaryText:           "text-gray-500",
    buttonBackground:        "bg-gray-100 border border-gray-200",
    buttonActiveBackground:  "bg-gray-900",
    ...
    sliderSize:              "md",
    accentColor:             "red",
    okBackground:            "bg-gray-200",
    okBackgroundActive:      "bg-gray-800",
  },
