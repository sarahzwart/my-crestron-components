      ...
      >
        <div className={`relative w-full aspect-square rounded-full ${theme.buttonBackground}`}>
          <CH5Button
            ...
            className="absolute inset-0 w-full h-full px-0 pt-[6%] pb-[75%] [clip-path:polygon(50%_50%,0%_0%,100%_0%)]"
          />
          <CH5Button
            variant="momentary" shape="circle" offClassName={wedgeOff} onClassName={wedgeOn}
            icon={<ChevronDown />} iconSize={32} commandSignal={signalDown}
            className="absolute inset-0 w-full h-full px-0 pb-[6%] pt-[75%] [clip-path:polygon(50%_50%,100%_100%,0%_100%)]"
          />
          <CH5Button
            variant="momentary" shape="circle" offClassName={wedgeOff} onClassName={wedgeOn}
            icon={<ChevronLeft />} iconSize={32} commandSignal={signalLeft}
            className="absolute inset-0 w-full h-full py-0 pl-[6%] pr-[75%] [clip-path:polygon(50%_50%,0%_0%,0%_100%)]"
          />
          <CH5Button
            variant="momentary" shape="circle" offClassName={wedgeOff} onClassName={wedgeOn}
            icon={<ChevronRight />} iconSize={32} commandSignal={signalRight}
            className="absolute inset-0 w-full h-full py-0 pr-[6%] pl-[75%] [clip-path:polygon(50%_50%,100%_0%,100%_100%)]"
          />
        ...
        <div className="grid grid-cols-2 gap-[1.5vh] w-full">
          <div className="aspect-square">
            <CH5Button variant="momentary" shape="circle" offClassName={roundOff} onClassName={roundOn}
              icon={<ChevronLeft />} iconSize={28} commandSignal={signalBack}
              className="w-full h-full p-0" />
          </div>
          <div className="aspect-square">
            <CH5Button variant="momentary" shape="circle" offClassName={roundOff} onClassName={roundOn}
              icon={<Home />} iconSize={28} commandSignal={signalHome}
              className="w-full h-full p-0" />
          </div>
          <div className="aspect-square">
            <CH5Button variant="momentary" shape="circle" offClassName={roundOff} onClassName={roundOn}
              icon={<Menu />} iconSize={28} commandSignal={signalMenu}
              className="w-full h-full p-0" />
          </div>
          <div className="aspect-square">
            <CH5Button variant="momentary" shape="circle" offClassName={roundOff} onClassName={roundOn}
              icon={<Play />} iconSize={28} commandSignal={signalPlayPause}
              className="w-full h-full p-0" />
          </div>
        </div>
      </div>
