...
export function OverviewPage() {
  ...
  return (
    <div
      className={`h-full w-full flex overflow-x-auto snap-x snap-mandatory ${theme.pageBackground}`}
    >
      <div className="w-full h-full shrink-0 snap-center grid grid-cols-3 grid-rows-4 overflow-hidden gap-4 p-4">
        <Card
