            ...
            {AUDIO_CONTROLS.map((control) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <span className={`${theme.primaryText} text-lg font-medium`}>
                    {control.label}
                  </span>
                  <CH5MuteButton
      ...
      <Card className={`${theme.cardBackground} col-span-1 row-span-3`}>
            ...
            <div className="flex gap-1">
              {Array.from({ length: 3 }, (_, i) => i + 1).map((cam) => (
                <button
                  ...
                  className={`w-16 h-12 rounded text-xs font-mono font-semibold transition-all
                        ${
                          activeCamera === cam
        ...
        <CardContent className="p-0 flex-1 flex flex-col gap-2 min-h-0">
          ...
          <div className="flex flex-col gap-1">
            <span
              className={`${theme.primaryText} text-sm font-mono text-center p-2`}
            >
              PRESETS
            </span>
