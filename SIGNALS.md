...
| `Phone.Keypad_Star` | Digital | → Processor |
| `Phone.Keypad_Star_FB` | Digital | ← Processor |
| `Phone.Keypad_Pound` | Digital | → Processor |
| `Phone.Keypad_Pound_FB` | Digital | ← Processor |
...
| `Camera.Preset_{p}_FB` | Digital | ← Processor |
...
| Signal | Type | Direction |
|---|---|---|
| `Settings.Theme` | Analog | → Processor |
| `Settings.Theme_FB` | Analog | ← Processor |
...
| Signal | Type | Direction |
|---|---|---|
| `Settings.Font` | Analog | → Processor |
| `Settings.Font_FB` | Analog | ← Processor |
